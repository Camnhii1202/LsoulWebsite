...
<section id="header">
    ...
    <div>
        <ul id="navbar" class="navbar">
            ...
            <li id="lg-acc"><a href="<?php echo BASE_PATH . '/me' ?>"><i class="fa-solid fa-user"></i></a></li>
            <li id="lg-search"><a href="<?php echo BASE_PATH . '/shop' ?>"><i class="fa-solid fa-search"></i></a></li>
            <li id="lg-bag"><a href="<?php echo BASE_PATH . '/carts' ?>"><i class="fa-solid fa-cart-shopping"></i></a>
            </li>
        </ul>
    </div>
